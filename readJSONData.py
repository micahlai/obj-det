...
def combineResults(save_dir=d_save_dir,
    ...
    saveData.plotDataLineByGradientTotal(NmAP,NTrainT,file="No Ylim : CV3/Class ",datasetAttribute="classes", dontIgnore = ig,ignoreDataset=datasetIgnore)
    saveData.plotDataLineByGradientTotal(NmAP,NTrainT,file="No Ylim : CV3/Ratio ",datasetAttribute="ratio", dontIgnore = ig,ignoreDataset=datasetIgnore)
    saveData.plotDataLineByGradientTotal(NmAP,NTrainT,file="No Ylim : CV3/Size ",datasetAttribute="size",dontIgnore=ig,ignoreDataset=datasetIgnore)
    saveData.plotDataLineByGradientTotal(NmAP,NTrainT,file="No Ylim : CV3/Count ",datasetAttribute="count",dontIgnore=ig,ignoreDataset=datasetIgnore)

    saveData.createSubfolderwithNameInResults("Bar Results")
    saveData.plotBarByGradientTotal(NmAP,NTrainT,yVal="fav",file="Bar Results/Fav ")
    saveData.plotBarByGradientTotal(NmAP,NTrainT,yVal="time",file="Bar Results/Time ")
    saveData.plotBarByGradientTotal(NmAP,NTrainT,yVal="mAP",file="Bar Results/mAP ")

    saveData.createSubfolderwithNameInResults("YLim to CV3")
    saveData.plotDataLineByGradientTotal(NmAP,NTrainT,file="YLim to CV3/Class ",yLimToLSRL=True,datasetAttribute="classes", dontIgnore = ig,ignoreDataset=datasetIgnore)
    saveData.plotDataLineByGradientTotal(NmAP,NTrainT,file="YLim to CV3/Ratio ",yLimToLSRL=True,datasetAttribute="ratio", dontIgnore = ig,ignoreDataset=datasetIgnore)
    saveData.plotDataLineByGradientTotal(NmAP,NTrainT,file="YLim to CV3/Size ",yLimToLSRL=True,datasetAttribute="size",dontIgnore=ig,ignoreDataset=datasetIgnore)
    saveData.plotDataLineByGradientTotal(NmAP,NTrainT,file="YLim to CV3/Count ",yLimToLSRL=True,datasetAttribute="count",dontIgnore=ig,ignoreDataset=datasetIgnore)

    saveData.createSubfolderwithNameInResults("Cuttoff Line")
    saveData.plotDataLineByGradientTotal(NmAP,NTrainT,file="Cuttoff Line/Class ",correCutoff=0.5,yLimToLSRL=True,datasetAttribute="classes",ignoreDataset=datasetIgnore)
    saveData.plotDataLineByGradientTotal(NmAP,NTrainT,file="Cuttoff Line/Ratio ",correCutoff=0.5,yLimToLSRL=True,datasetAttribute="ratio",ignoreDataset=datasetIgnore)
    saveData.plotDataLineByGradientTotal(NmAP,NTrainT,file="Cuttoff Line/Size ",correCutoff=0.5,yLimToLSRL=True,datasetAttribute="size",ignoreDataset=datasetIgnore)
    saveData.plotDataLineByGradientTotal(NmAP,NTrainT,file="Cuttoff Line/Count ",correCutoff=0.5,yLimToLSRL=True,datasetAttribute="count",ignoreDataset=datasetIgnore)

    saveData.createSubfolderwithNameInResults("Cuttoff No Dotted Line")
    saveData.plotDataLineByGradientTotal(NmAP,NTrainT,file="Cuttoff No Dotted Line/Class ",correCutoff=0.5,cuttoffDotted=False,yLimToLSRL=True,datasetAttribute="classes",ignoreDataset=datasetIgnore)
    saveData.plotDataLineByGradientTotal(NmAP,NTrainT,file="Cuttoff No Dotted Line/Ratio ",correCutoff=0.5,cuttoffDotted=False,yLimToLSRL=True,datasetAttribute="ratio",ignoreDataset=datasetIgnore)
    saveData.plotDataLineByGradientTotal(NmAP,NTrainT,file="Cuttoff No Dotted Line/Size ",correCutoff=0.5,cuttoffDotted=False,yLimToLSRL=True,datasetAttribute="size",ignoreDataset=datasetIgnore)
    saveData.plotDataLineByGradientTotal(NmAP,NTrainT,file="Cuttoff No Dotted Line/Count ",correCutoff=0.5,cuttoffDotted=False,yLimToLSRL=True,datasetAttribute="count",ignoreDataset=datasetIgnore)
